...
| | `Marcaj_Siret3_Dataset_Brief_EN.pdf` | imagery card: ~145 ha, 3.52 cm/px, Mavic 3E, 658.6 MB source GeoTIFF (see [`docs/siret3-dataset.md`](../../docs/siret3-dataset.md)) |
...
| `04_source/` | `siret3_source_orthomosaic_EPSG4326.tif` | the full original orthomosaic (**658.6 MB** on the dataset brief, **EPSG:4326**, as published on OpenAerialMap) — only for training on the whole survey |
